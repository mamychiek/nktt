...
// Assuming you have a list of widgets named postItems
List<Widget> postItems = [];

// Populate the postItems list with your desired content
// For example:
                  ...
                  children: <Widget>[
                    ...
                    Positioned(
                      ...
                      child: Container(
                        ...
                        child: Text(
                          'No. ${imgList.indexOf(item as String)} image',
